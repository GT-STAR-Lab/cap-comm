...
python3 src/main.py with alg_yaml=mappo_gnn capabilities_skip_gnn=True capability_shape=1 env_yaml=gymma batch_size_run=64 batch_size=32 buffer_size=32 \
env_args.time_limit=1000 env_args.key="robotarium_gym:HeterogeneousSensorNetwork-v0" t_max=20500000 which_seed="seed_3"

# python3 src/main.py with alg_yaml=mappo_gnn capabilities_skip_gnn=True capability_shape=1 env_yaml=gymma batch_size_run=16 batch_size=32 buffer_size=32 \
