...
python3 src/main.py with alg_yaml=mappo_gnn env_yaml=gymma capabilities_skip_gnn=True capability_shape=1 batch_size_run=16 batch_size=32 buffer_size=32 \
