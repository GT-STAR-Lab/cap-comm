...
# MAKE SURE THE AGENTS IS SET TO CAPABILITY AWARE IN THE mpe/scenarios/configs/material_transport directory.

python3 src/main.py with alg_yaml=mappo_gnn agent="gnn" capabilities_skip_gnn=True env_yaml=gymma batch_size_run=64 \
